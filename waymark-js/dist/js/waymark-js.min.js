...
//!!! To-do - move this into Waymark.map_was_edited()	  	  
Waymark.save_data_layer()}Waymark.map_was_edited(),Waymark.loading_stop()}})},this.build_content=function(t,e,i){Waymark=this;var n=jQuery("<div />"),a=jQuery("<ul />").addClass("waymark-info");if("line"==t||"shape"==t){var o=jQuery("<button />").html('<i class="ion-edit"></i>').addClass("button").attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(e){e.preventDefault();var n=jQuery(this),a=jQuery("i",n);return i.editEnabled()?(i.disableEdit(),n.attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])),a.attr("class","ion-edit"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!1)):(i.enableEdit(),i.closePopup(),n.attr("title",waymark_js.lang.action_edit_done),a.attr("class","ion-android-done"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!0)),!1}));a.append(jQuery("<li />").addClass("waymark-info-button waymark-info-edit waymark-"+t+"-edit").append(o))}o=jQuery("<button />").html('<i class="ion-ios-copy"></i>').addClass("button").attr("title",waymark_js.lang.action_duplicate+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(t){return t.preventDefault(),Waymark.load_json(Object.assign({},i.feature)),Waymark.map_was_edited(),!1}));a.append(jQuery("<li />").addClass("waymark-info-button waymark-info-duplicate waymark-"+t+"-duplicate").append(o));o=jQuery("<button />").html('<i class="ion-trash-a"></i>').addClass("button").attr("title",waymark_js.lang.action_delete+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(n){return n.preventDefault(),!("1"==Waymark.config.editor_options.confirm_delete&&!confirm(waymark_js.lang.action_delete_confirm+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])+"?"))&&(Waymark.map.removeLayer(i),Waymark.map_data.removeLayer(i),Waymark.save_data_layer(),Waymark.map_was_edited(),"function"==typeof Waymark.config.handle_delete_callback&&Waymark.config.handle_delete_callback(e),!1)}));a.append(jQuery("<li />").addClass("waymark-info-button waymark-info-delete waymark-"+t+"-delete").append(o));var r=Waymark.config[t+"_types"],s=jQuery("<select />");for(var l in s.append(jQuery("<option />").attr({disabled:"disabled"}).text(Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_type_label+":")),r){var h=Waymark.make_key(r[l][t+"_title"]);s.append(jQuery("<option />").val(h).text(r[l][t+"_title"]))}s.change((function(){jQuery("option:selected",jQuery(this));var n=jQuery(this).val();if(e.properties.type=n,"object"!=typeof n)var a=Waymark.get_type(t,e.properties.type);switch(t){case"line":i.setStyle({color:a.line_colour,weight:a.line_weight});break;case"shape":i.setStyle({color:a.shape_colour,fillOpacity:a.fill_opacity});break;case"marker":i.setIcon(L.divIcon(Waymark.build_icon_data(a)))}Waymark.save_data_layer(),Waymark.map_was_edited()})),a.append(jQuery("<li />").addClass("waymark-info-type waymark-"+t+"-type").append(s)),jQuery("option",s).filter((function(){return jQuery(this).val()==Waymark.make_key(e.properties.type)})).attr("selected","selected");var d=jQuery("<div />").addClass("waymark-overlay-preview waymark-"+t+"-preview");for(var l in r){var c=r[l][t+"_title"],u=(h=Waymark.make_key(c),Waymark.get_type(t,h)),_=jQuery("<div />").addClass("waymark-type").data("type_key",h).attr("title",c);switch(t){case"marker":var p=Waymark.build_icon_data(u);_.addClass(p.className).html(p.html).css({width:p.iconSize[0],height:p.iconSize[1]});break;case"line":_.addClass("waymark-line").append(jQuery("<div />").css({margin:"15px 0",height:"1px",borderTop:u.line_weight+"px solid "+u.line_colour}));break;case"shape":_.addClass("waymark-shape").css({border:"3px solid "+u.shape_colour}).append(jQuery("<div />").css({height:"20px",background:u.shape_colour,opacity:u.fill_opacity}))}var m=jQuery("<div />").addClass("waymark-overlay-wrap waymark-"+t+"-wrap");"1"==Waymark.config.map_options.show_type_labels&&m.append(jQuery("<div />").addClass("waymark-type-title").text(c)),m.append(_),m.on("click",(function(){var e=(_=jQuery(".waymark-type",jQuery(this))).data("type_key");jQuery("option",s).each((function(){_.val()==e?_.attr("selected","selected"):_.removeAttr("selected")})),s.val(e),s.trigger("change"),jQuery(".waymark-"+t+"-wrap",d).each((function(){_.removeClass("waymark-active")})),_.parent(".waymark-"+t+"-wrap").addClass("waymark-active")})),h==Waymark.make_key(e.properties.type)?(m.addClass("waymark-active"),d.prepend(m)):d.append(m)}for(key in a.append(d),Waymark.config[t+"_data_defaults"]){o=null;switch(key){case"title":o=jQuery("<input />").attr({type:"text",value:e.properties.title,placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_title_placeholder}).on("change",(function(){e.properties.title=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"description":o=jQuery("<textarea />").attr({id:"waymark-info-description",class:"wp-editor",placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_description_placeholder}).val(e.properties.description).on("change",(function(){e.properties.description=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"image_large_url":var f=jQuery("<input />").attr({value:e.properties.image_large_url,placeholder:waymark_js.lang.object_image_placeholder}).on("change",(function(){e.properties.image_large_url=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));if(void 0!==e.properties.image_thumbnail_url)var g=e.properties.image_thumbnail_url;else g=e.properties.image_large_url;var y=jQuery("<img />").attr({src:g,width:160});f.on("change",(function(){y.attr("src",jQuery(this).val())}));var v=jQuery("<a />").attr({href:e.properties.image_large_url,target:"_blank"}).append(y).hover((function(){jQuery(this).addClass("waymark-hover")}),(function(){jQuery(this).removeClass("waymark-hover")})),k=jQuery("<button />").text(waymark_js.lang.action_upload_image).attr({type:"submit",name:"add_photo",class:"waymark-input button button-small",id:"add_photo"}).on("click",(function(t){if(t.preventDefault(),void 0!==wp.media)return wp.media.editor.send.attachment=function(t,i){if(Waymark.debug(i),void 0===i.url)return!1;var n=Waymark.get_image_sizes(i.sizes,i.url);e.properties=Object.assign({},e.properties,n),v.attr("href",e.properties.image_large_url),jQuery("img",v).attr("src",e.properties.image_thumbnail_url),f.val(e.properties.image_large_url),Waymark.save_data_layer(),Waymark.map_was_edited()},wp.media.editor.open(),!1;var i=jQuery("<input />").attr({type:"file",name:"marker_photo"}).css("display","none").change((function(){Waymark.handle_file_upload(jQuery(this),{feature:e,img_view:v,img_input:f})}));jQuery("#waymark-edit-toolbar").append(i),i.trigger("click")}));o=jQuery("<div />").append(v,f,k)}o&&a.append(jQuery("<li />").addClass("waymark-info-"+key+" waymark-"+t+"-info-"+key).append(o))}if("marker"==t&&void 0!==i.feature.geometry.coordinates){i.feature.geometry.coordinates;var w=i.feature.geometry.coordinates[1],b=i.feature.geometry.coordinates[0];"number"==typeof w&&(b=b.toFixed(6),w=w.toFixed(6)),o=jQuery("<small>").html("<b>"+waymark_js.lang.marker_latlng_label+"</b>: "+w+","+b),a.append(jQuery("<li />").addClass("waymark-info-latlng waymark-marker-info-latlng").append(o))}return a.children().length&&n.append(a),n},this.info_window=function(t,e,i){Waymark=this;var n=Waymark.title_case(waymark_js.lang.action_edit+" "+t);if("function"==typeof Waymark.config.handle_content_callback)i.on("click",(function(){var a=Waymark.build_content(t,e,i);Waymark.config.handle_content_callback(a.get(0),n,Waymark.mode)}));else{var a=Waymark.build_content(t,e,i).get(0);i.bindPopup(a,{}).openPopup().on("click",(function(){}))}},this.load_file_contents=function(t,e){switch(Waymark=this,t=t.trim(),e=e.toLowerCase()){case"gpx":var i=(new DOMParser).parseFromString(t,"text/xml"),n=toGeoJSON.gpx(i);break;case"kml":var a=(new DOMParser).parseFromString(t,"text/xml");n=toGeoJSON.kml(a);break;case"json":case"geojson":n=JSON.parse(t);break;default:Waymark.message(waymark_js.lang.error_file_type,"error")}void 0!==n?this.load_json(n):Waymark.message(waymark_js.lang.error_file_conversion,"error")},this.load_json=function(t){if(Waymark=this,"object"==typeof t){Waymark.map_data.addData(t),Waymark.save_data_layer();var e=Waymark.map_data.getBounds();e.isValid()&&Waymark.map.fitBounds(e)}}}function Waymark_Map_Query(){this.create_buttons=function(){},this.build_content=function(t,e,i,n="map_data"){Waymark=this;var a=jQuery("<div />");switch(n){case"query_data":var o=jQuery("<ul />").addClass("waymark-info waymark-query-info waymark-"+t+"-info");for(key in Waymark.config[t+"_data_defaults"]){var r=null;switch(key){case"title":e.properties.title?r=jQuery("<strong />").html(e.properties.title):(r=jQuery("<strong />").html("&nbsp;"),o.addClass("waymark-no-title"));break;case"type":if("1"!=Waymark.config.map_options.show_type_labels)break;var s=Waymark.get_type(t,e.properties.type);s&&(r=Waymark.type_to_text(t,s,"small"));break;case"description":var l=e.properties.description;l?r=0===l.indexOf("<")?l:jQuery("<p />").html(l):o.addClass("waymark-no-description");break;case"image_large_url":if(void 0!==e.properties.image_large_url){var h=e.properties.image_large_url;if(void 0!==e.properties.image_medium_url)h=e.properties.image_medium_url;r=jQuery("<a />").attr({href:e.properties.image_large_url,target:"_blank",style:"background-image:url("+h+")"})}else o.addClass("waymark-no-image")}r&&o.append(jQuery("<li />").addClass("waymark-info-"+key+" waymark-"+t+"-info-"+key).append(r))}o.children().length&&a.append(o)}return a},this.load_query_json=function(t,e=1){if(Waymark=this,"object"==typeof t){void 0!==Waymark.queries_data[e]&&(Waymark.map.removeLayer(Waymark.queries_data[e]),Waymark.query_data_group.removeLayer(Waymark.queries_data[e])),Waymark.queries_data[e]=Waymark_L.geoJSON(null,{pointToLayer:function(t,e){return Waymark.create_marker(e,{draggable:!1})},onEachFeature:function(t,e){Waymark.setup_query_data_feature(t,e)}}),Waymark.queries_data[e].addData(t),Waymark.queries_data[e].addTo(Waymark.map),Waymark.query_data_group.addLayer(Waymark.queries_data[e]);var i=Waymark.query_data_group.getBounds();i.isValid()&&Waymark.map.fitBounds(i),Waymark.save_query_data()}},this.save_query_data=function(){var t=jQuery(".waymark-input-query_data").first(),e=JSON.stringify(Waymark.query_data_group.toGeoJSON());t.html(e)}}function Waymark_Map_Factory(){this.instances=[],this.viewer=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Viewer);return this.instances.push(t),t},this.editor=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Editor);return this.instances.push(t),t},this.query=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Query);return this.instances.push(t),t}}window.Waymark_Map_Factory=new Waymark_Map_Factory;