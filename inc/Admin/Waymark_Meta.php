...
class Waymark_Meta {
	...
	function map_help_content() {
		...
		echo '<p>' . sprintf(wp_kses(__('Add and edit Basemaps in <a href="%s" target="_blank">Waymark &gt; Settings</a>. The first listed will be used as the default, unless specified in the shortcode like this: %s', 'waymark'), ['a' => ['href' => [], 'target' => []]]), esc_url(admin_url('edit.php?post_type=waymark_map&page=waymark-settings&tab=tiles')), '<code>[Waymark map_id="1234" basemap="Basemap Name"]</code>') . '</p>';
