...
//!!! To-do - move this into Waymark.map_was_edited()	  	  
Waymark.save_data_layer()}Waymark.map_was_edited(),Waymark.loading_stop()}})},this.build_content=function(t,e,i){Waymark=this;var n=jQuery("<div />"),o=jQuery("<ul />").addClass("waymark-info");if("line"==t||"shape"==t){var a=jQuery("<button />").html('<i class="ion-edit"></i>').addClass("button").attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(e){e.preventDefault();var n=jQuery(this),o=jQuery("i",n);return i.editEnabled()?(i.disableEdit(),n.attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])),o.attr("class","ion-edit"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!1)):(i.enableEdit(),i.closePopup(),n.attr("title",waymark_js.lang.action_edit_done),o.attr("class","ion-android-done"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!0)),!1}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-edit waymark-"+t+"-edit").append(a))}a=jQuery("<button />").html('<i class="ion-ios-copy"></i>').addClass("button").attr("title",waymark_js.lang.action_duplicate+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(t){return t.preventDefault(),Waymark.load_json(Object.assign({},i.feature)),Waymark.map_was_edited(),!1}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-delete waymark-"+t+"-delete").append(a));a=jQuery("<button />").html('<i class="ion-trash-a"></i>').addClass("button").attr("title",waymark_js.lang.action_delete+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(n){return n.preventDefault(),!("1"==Waymark.config.editor_options.confirm_delete&&!confirm(waymark_js.lang.action_delete_confirm+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])+"?"))&&(Waymark.map.removeLayer(i),Waymark.map_data.removeLayer(i),Waymark.save_data_layer(),Waymark.map_was_edited(),"function"==typeof Waymark.config.handle_delete_callback&&Waymark.config.handle_delete_callback(e),!1)}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-delete waymark-"+t+"-delete").append(a));var r=Waymark.config[t+"_types"];a=jQuery("<select />");for(var s in a.append(jQuery("<option />").attr({disabled:"disabled"}).text(Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_type_label+":")),r){var l=Waymark.make_key(r[s][t+"_title"]);a.append(jQuery("<option />").val(l).text(r[s][t+"_title"]))}if("function"==typeof Waymark.config.handle_custom_type_callback){a.append(jQuery("<option />").attr("disabled","disabled").text("──────────"));var h=jQuery("<option />").attr("id","custom_type").val("{}").text("Custom");a.append(h)}if(a.change((function(){var n=jQuery("option:selected",jQuery(this));if("custom_type"==n.attr("id"))"function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,i,n);else{"function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,i,n,"hide");var o=jQuery(this).val();if(e.properties.type=o,"object"!=typeof o)var a=Waymark.get_type(t,e.properties.type);switch(t){case"line":i.setStyle({color:a.line_colour,weight:a.line_weight});break;case"shape":i.setStyle({color:a.shape_colour,fillOpacity:a.fill_opacity});break;case"marker":i.setIcon(L.divIcon(Waymark.build_icon_data(a)))}Waymark.save_data_layer(),Waymark.map_was_edited()}})),o.append(jQuery("<li />").addClass("waymark-info-type waymark-"+t+"-type").append(a)),"object"==typeof e.properties.type?"function"==typeof Waymark.config.handle_custom_type_callback&&(Waymark.config.handle_custom_type_callback(t,i,h,"show"),h.attr("selected","selected")):("function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,i,h,"hide"),jQuery("option",a).filter((function(){return jQuery(this).val()==Waymark.make_key(e.properties.type)})).attr("selected","selected")),"marker"==t){var d=jQuery("<div />").addClass("waymark-marker-preview");for(var s in r){l=Waymark.make_key(r[s][t+"_title"]);var c=Waymark.get_type("marker",l),u=Waymark.build_icon_data(c);console.log(u),d.append(jQuery("<div />").addClass(u.className).html(u.html).width(u.iconSize[0]).height(u.iconSize[1]))}o.append(d)}for(key in Waymark.config[t+"_data_defaults"]){a=null;switch(key){case"title":a=jQuery("<input />").attr({type:"text",value:e.properties.title,placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_title_placeholder}).on("change",(function(){e.properties.title=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"description":a=jQuery("<textarea />").attr({id:"waymark-info-description",class:"wp-editor",placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_description_placeholder}).val(e.properties.description).on("change",(function(){e.properties.description=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"image_large_url":var _=jQuery("<input />").attr({value:e.properties.image_large_url,placeholder:waymark_js.lang.object_image_placeholder}).on("change",(function(){e.properties.image_large_url=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));if(void 0!==e.properties.image_thumbnail_url)var p=e.properties.image_thumbnail_url;else p=e.properties.image_large_url;var m=jQuery("<img />").attr({src:p,width:160});_.on("change",(function(){m.attr("src",jQuery(this).val())}));var f=jQuery("<a />").attr({href:e.properties.image_large_url,target:"_blank"}).append(m).hover((function(){jQuery(this).addClass("waymark-hover")}),(function(){jQuery(this).removeClass("waymark-hover")})),g=jQuery("<button />").text(waymark_js.lang.action_upload_image).attr({type:"submit",name:"add_photo",class:"waymark-input button button-small",id:"add_photo"}).on("click",(function(t){if(t.preventDefault(),void 0!==wp.media)return wp.media.editor.send.attachment=function(t,i){if(Waymark.debug(i),void 0===i.url)return!1;var n=Waymark.get_image_sizes(i.sizes,i.url);e.properties=Object.assign({},e.properties,n),f.attr("href",e.properties.image_large_url),jQuery("img",f).attr("src",e.properties.image_thumbnail_url),_.val(e.properties.image_large_url),Waymark.save_data_layer(),Waymark.map_was_edited()},wp.media.editor.open(),!1;var i=jQuery("<input />").attr({type:"file",name:"marker_photo"}).css("display","none").change((function(){Waymark.handle_file_upload(jQuery(this),{feature:e,img_view:f,img_input:_})}));jQuery("#waymark-edit-toolbar").append(i),i.trigger("click")}));a=jQuery("<div />").append(f,_,g)}a&&o.append(jQuery("<li />").addClass("waymark-info-"+key+" waymark-"+t+"-info-"+key).append(a))}if("marker"==t&&void 0!==i.feature.geometry.coordinates){i.feature.geometry.coordinates;var y=i.feature.geometry.coordinates[1],v=i.feature.geometry.coordinates[0];"number"==typeof y&&(v=v.toFixed(6),y=y.toFixed(6)),a=jQuery("<small>").html("<b>"+waymark_js.lang.marker_latlng_label+"</b>: "+y+","+v),o.append(jQuery("<li />").addClass("waymark-info-latlng waymark-marker-info-latlng").append(a))}return o.children().length&&n.append(o),n},this.info_window=function(t,e,i){Waymark=this;var n=Waymark.title_case(waymark_js.lang.action_edit+" "+t);if("function"==typeof Waymark.config.handle_content_callback)i.on("click",(function(){var o=Waymark.build_content(t,e,i);Waymark.config.handle_content_callback(o.get(0),n,Waymark.mode)}));else{var o=Waymark.build_content(t,e,i).get(0);i.bindPopup(o,{}).openPopup().on("click",(function(){}))}},this.load_file_contents=function(t,e){switch(Waymark=this,t=t.trim(),e=e.toLowerCase()){case"gpx":var i=(new DOMParser).parseFromString(t,"text/xml"),n=toGeoJSON.gpx(i);break;case"kml":var o=(new DOMParser).parseFromString(t,"text/xml");n=toGeoJSON.kml(o);break;case"json":case"geojson":n=JSON.parse(t);break;default:Waymark.message(waymark_js.lang.error_file_type,"error")}void 0!==n?this.load_json(n):Waymark.message(waymark_js.lang.error_file_conversion,"error")},this.load_json=function(t){if(Waymark=this,"object"==typeof t){Waymark.map_data.addData(t),Waymark.save_data_layer();var e=Waymark.map_data.getBounds();e.isValid()&&Waymark.map.fitBounds(e)}}}function Waymark_Map_Factory(){this.instances=[],this.viewer=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Viewer);return this.instances.push(t),t},this.editor=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Editor);return this.instances.push(t),t}}window.Waymark_Map_Factory=new Waymark_Map_Factory;