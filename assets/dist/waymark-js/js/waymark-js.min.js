...
//!!! To-do - move this into Waymark.map_was_edited()	  	  
Waymark.save_data_layer()}Waymark.map_was_edited(),Waymark.loading_stop()}})},this.build_content=function(t,e,n){Waymark=this;var a=jQuery("<div />"),o=jQuery("<ul />").addClass("waymark-info");if("line"==t||"shape"==t){var r=jQuery("<button />").html('<i class="ion-edit"></i>').addClass("button").attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(e){e.preventDefault();var i=jQuery(this),a=jQuery("i",i);return n.editEnabled()?(n.disableEdit(),i.attr("title",waymark_js.lang.action_edit+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])),a.attr("class","ion-edit"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!1)):(n.enableEdit(),n.closePopup(),i.attr("title",waymark_js.lang.action_edit_done),a.attr("class","ion-android-done"),"function"==typeof Waymark.config.handle_edit_callback&&Waymark.config.handle_edit_callback(!0)),!1}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-edit waymark-"+t+"-edit").append(r))}r=jQuery("<button />").html('<i class="ion-ios-copy"></i>').addClass("button").attr("title",waymark_js.lang.action_duplicate+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(t){return t.preventDefault(),Waymark.load_json(Object.assign({},n.feature)),Waymark.map_was_edited(),!1}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-delete waymark-"+t+"-delete").append(r));r=jQuery("<button />").html('<i class="ion-trash-a"></i>').addClass("button").attr("title",waymark_js.lang.action_delete+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])).on("click",(function(i){return i.preventDefault(),!("1"==Waymark.config.editor_options.confirm_delete&&!confirm(waymark_js.lang.action_delete_confirm+" "+Waymark.title_case(waymark_js.lang["object_label_"+t])+"?"))&&(Waymark.map.removeLayer(n),Waymark.map_data.removeLayer(n),Waymark.save_data_layer(),Waymark.map_was_edited(),"function"==typeof Waymark.config.handle_delete_callback&&Waymark.config.handle_delete_callback(e),!1)}));o.append(jQuery("<li />").addClass("waymark-info-button waymark-info-delete waymark-"+t+"-delete").append(r));var s=Waymark.config[t+"_types"];r=jQuery("<select />");for(i in r.append(jQuery("<option />").attr({disabled:"disabled"}).text(Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_type_label+":")),s){var l=Waymark.make_key(s[i][t+"_title"]);r.append(jQuery("<option />").val(l).text(s[i][t+"_title"]))}if("function"==typeof Waymark.config.handle_custom_type_callback){r.append(jQuery("<option />").attr("disabled","disabled").text("──────────"));var h=jQuery("<option />").attr("id","custom_type").val("{}").text("Custom");r.append(h)}for(key in r.change((function(){var i=jQuery("option:selected",jQuery(this));if("custom_type"==i.attr("id"))"function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,n,i);else{"function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,n,i,"hide");var a=jQuery(this).val();if(e.properties.type=a,"object"!=typeof a)var o=Waymark.get_type(t,e.properties.type);switch(t){case"line":n.setStyle({color:o.line_colour,weight:o.line_weight});break;case"shape":n.setStyle({color:o.shape_colour,fillOpacity:o.fill_opacity});break;case"marker":n.setIcon(L.divIcon(Waymark.build_icon_data(o)))}Waymark.save_data_layer(),Waymark.map_was_edited()}})),o.append(jQuery("<li />").addClass("waymark-info-type waymark-"+t+"-type").append(r)),"object"==typeof e.properties.type?"function"==typeof Waymark.config.handle_custom_type_callback&&(Waymark.config.handle_custom_type_callback(t,n,h,"show"),h.attr("selected","selected")):("function"==typeof Waymark.config.handle_custom_type_callback&&Waymark.config.handle_custom_type_callback(t,n,h,"hide"),jQuery("option",r).filter((function(){return jQuery(this).val()==Waymark.make_key(e.properties.type)})).attr("selected","selected")),Waymark.config[t+"_data_defaults"]){r=null;switch(key){case"title":r=jQuery("<input />").attr({type:"text",value:e.properties.title,placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_title_placeholder}).on("change",(function(){e.properties.title=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"description":r=jQuery("<textarea />").attr({id:"waymark-info-description",class:"wp-editor",placeholder:Waymark.title_case(waymark_js.lang["object_label_"+t])+" "+waymark_js.lang.object_description_placeholder}).val(e.properties.description).on("change",(function(){e.properties.description=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));break;case"image_large_url":var d=jQuery("<input />").attr({value:e.properties.image_large_url,placeholder:waymark_js.lang.object_image_placeholder}).on("change",(function(){e.properties.image_large_url=jQuery(this).val(),Waymark.save_data_layer(),Waymark.map_was_edited()}));if(void 0!==e.properties.image_thumbnail_url)var c=e.properties.image_thumbnail_url;else c=e.properties.image_large_url;var u=jQuery("<img />").attr({src:c,width:160});d.on("change",(function(){u.attr("src",jQuery(this).val())}));var _=jQuery("<a />").attr({href:e.properties.image_large_url,target:"_blank"}).append(u).hover((function(){jQuery(this).addClass("waymark-hover")}),(function(){jQuery(this).removeClass("waymark-hover")})),p=jQuery("<button />").text(waymark_js.lang.action_upload_image).attr({type:"submit",name:"add_photo",class:"waymark-input button button-small",id:"add_photo"}).on("click",(function(t){if(t.preventDefault(),void 0!==wp.media)return wp.media.editor.send.attachment=function(t,i){if(Waymark.debug(i),void 0===i.url)return!1;var n=Waymark.get_image_sizes(i.sizes,i.url);e.properties=Object.assign({},e.properties,n),_.attr("href",e.properties.image_large_url),jQuery("img",_).attr("src",e.properties.image_thumbnail_url),d.val(e.properties.image_large_url),Waymark.save_data_layer(),Waymark.map_was_edited()},wp.media.editor.open(),!1;var i=jQuery("<input />").attr({type:"file",name:"marker_photo"}).css("display","none").change((function(){Waymark.handle_file_upload(jQuery(this),{feature:e,img_view:_,img_input:d})}));jQuery("#waymark-edit-toolbar").append(i),i.trigger("click")}));r=jQuery("<div />").append(_,d,p)}r&&o.append(jQuery("<li />").addClass("waymark-info-"+key+" waymark-"+t+"-info-"+key).append(r))}if("marker"==t&&void 0!==n.feature.geometry.coordinates){n.feature.geometry.coordinates;var m=n.feature.geometry.coordinates[1],f=n.feature.geometry.coordinates[0];"number"==typeof m&&(f=f.toFixed(6),m=m.toFixed(6)),r=jQuery("<small>").html("<b>"+waymark_js.lang.marker_latlng_label+"</b>: "+m+","+f),o.append(jQuery("<li />").addClass("waymark-info-latlng waymark-marker-info-latlng").append(r))}return o.children().length&&a.append(o),a},this.info_window=function(t,e,i){Waymark=this;var n=Waymark.title_case(waymark_js.lang.action_edit+" "+t);if("function"==typeof Waymark.config.handle_content_callback)i.on("click",(function(){var a=Waymark.build_content(t,e,i);Waymark.config.handle_content_callback(a.get(0),n,Waymark.mode)}));else{var a=Waymark.build_content(t,e,i).get(0);i.bindPopup(a,{}).openPopup().on("click",(function(){}))}},this.load_file_contents=function(t,e){switch(Waymark=this,t=t.trim(),e){case"gpx":var i=(new DOMParser).parseFromString(t,"text/xml"),n=toGeoJSON.gpx(i);break;case"kml":var a=(new DOMParser).parseFromString(t,"text/xml");n=toGeoJSON.kml(a);break;case"json":case"geojson":n=JSON.parse(t);break;default:Waymark.message(waymark_js.lang.error_file_type,"error")}void 0!==n?this.load_json(n):Waymark.message(waymark_js.lang.error_file_conversion,"error")},this.load_json=function(t){if(Waymark=this,"object"==typeof t){Waymark.map_data.addData(t),Waymark.save_data_layer();var e=Waymark.map_data.getBounds();e.isValid()&&Waymark.map.fitBounds(e)}}}function Waymark_Map_Factory(){this.instances=[],this.viewer=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Viewer);return this.instances.push(t),t},this.editor=function(){var t=Object.assign(new Waymark_Map,new Waymark_Map_Editor);return this.instances.push(t),t}}window.Waymark_Map_Factory=new Waymark_Map_Factory;